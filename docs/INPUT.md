...
Seeker tones play only while the seeker tracks a return; in boresight a radar missile sounds its lock tone on the bore return and falls silent inside minimum range.
