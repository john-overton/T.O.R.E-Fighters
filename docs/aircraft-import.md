...
| G / roll / rudder / departure | Partial source-based and fitted behavior, telemetry and shared scenario suite | Next scheduled producer/consumer, response and feedback work. [Flight-response plan](flight-response-plan.md) |
