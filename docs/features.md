...
| Engine contrails | ☐ | ☑ | Opinionated addition: 10 pale puffs per second per engine above a stable random 30,000-35,000-foot onset altitude, two statute miles long, fading only after 1.5 miles. Some engine attachments remain fitted; shared puff budget can shorten trails. | [Contrail rules](spec/damage-smoke.md); [validation](baselines/smoke-contrails.md) |
