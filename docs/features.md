...
| Warm continuous surface lighting and geometric shadows | ☐ | ☑ | Completed within finite shadow-map coverage. Opaque terrain, aircraft, debris and weapon bodies share sunlight and cast/receive shadows; water receives shadows. Visible sun fraction scales shadow strength independently of glare, caster distance controls soft edges, close-view transitions are more diffuse, shared terrain normals avoid lighting seams, painted panels have view-dependent highlights, and land shadows suppress water sun glints. Transparent effects and distant geometry beyond coverage remain outside the solid shadow pass. | [Surface lighting](spec/surface-lighting.md) |
