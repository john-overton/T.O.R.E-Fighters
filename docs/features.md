...
| Uncued launch with the onboard seeker enabled | ☐ | ☑ | Partially implemented. Simulation permits independent-seeker release without designation. Player controls, bay handling and HUD remain. | [Launch modes](spec/missiles.md#uncued-launch-and-narrow-ir-search) |
