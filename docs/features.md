...
| AI target selection, pursuit and maneuvering | ☑ | ☐ | Partially implemented. Retention, ranking, geometry, tactical choices, pursuit offsets, speed bands and B44 rate formulas have component tests. Live pursuit follows moving targets, ranking receives same-wing attacker counts, and achieved motion obeys the B44 bounds. Last-ditch shapes, random tactics and engagement pitch use fitted rules. | [B11 to B15](spec/ai.md#b12-approach-tactical-choice-and-pursuit) |
...
| AI formation and wing orders | ☑ | ☐ | Partially implemented. Each wing has its own leader and idle delta-formation following. Formation geometry and the isolated receiver contract are implemented. Automatic requests and player break, engage, disengage and formation commands are routed within the intended wing. Broader mission orders remain. The approach steering point and several radio phrases remain unrecovered. | [B43, B46](spec/ai.md#b43-wing-commands-and-formation-variation) |
