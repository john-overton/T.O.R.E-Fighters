...
| Takeoff, touchdown, taxi and braking | ☑ | ☑ | Partially implemented. Base-theater runway surfaces, airport-relative ILS calculations and manual landing completion work. Visible ILS and tower text controls work at 4,000 feet above airport ground. Speed brackets, campaign overlays, carrier landings and cross-platform runtime validation remain. | Manual pp. 63-71; [airport behavior](spec/airports.md) |
...
| Feature | Retail manual | Opinionated addition | Status and remaining work | Details |
| --- | :---: | :---: | --- | --- |
| Aircraft damage appearance and smoke | ☑ | ☑ | Partially implemented across all twelve supported aircraft with fitted breakup rules. Original bodies and detached pieces render at half health; damaged aircraft trail smoke with fitted spacing between puffs. Detached pieces fall and play an impact effect. Destroyed AI airframes keep falling under combat control, with a bridge/ground-contact regression test. Exact retail transitions remain unverified. | Manual pp. 161-163; [visual damage](spec/damage-smoke.md); [validation](baselines/damage-smoke.md) |
