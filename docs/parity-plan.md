...
| Ground contact and landing | Runway contact, taxi, brakes, touchdown; whole-wing ground starts and AI takeoff, landing and return to base ([airfield spec](spec/ai-airfield.md)) | **opinionated** contact; spec-derived airfield sequence with fitted flight control | [land foundation](baselines/native-land-foundation.md) |
