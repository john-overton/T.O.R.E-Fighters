...
| Skill-scaled AI visual awareness, frozen aircraft memory and search activity | Spec-derived implementation of opinionated requirements and agent-authored defaults | `ai::awareness`, `ai::mission`, `ai::controller`; [component provenance and rules](spec/ai-awareness.md#component-provenance) |
| AI search approach and orbit through the aircraft flight model | Fitted, agent-authored | [Search geometry and timing](spec/ai-awareness.md#searching-and-player-visible-activity); no imported original orbit claim |
| AI visibility without cloud/night attenuation | Fitted clear-air assumption | Terrain is queried; weather visibility is not yet supplied to AI perception. [Integration limits](spec/ai-awareness.md#integration-baseline) |
| Shared missile awareness and AI defensive decisions | Spec-derived implementation of opinionated rules | [Warning eligibility, time assessment and device rules](spec/ai-awareness.md#missile-awareness-and-defense); `combat::threats`, `ai::defense` |
| Active seeker notch and defensive maneuver-time estimate | Fitted, agent-authored | Shared Advanced radar notch and conservative loaded-flight estimates, documented in [missile defense](spec/ai-awareness.md#skill-time-available-and-returning-to-the-fight) |
| RWR missile/emitter presentation | Manual-derived symbols with opinionated timing and incomplete-measurement markers | [RWR contract](spec/rwr.md) |
| Mission engagement, group objectives and Shift-4 objective stamps | Spec-derived implementation of opinionated requirements | [Assignment and perception rules](spec/ai-awareness.md#mission-roles-and-rules-of-engagement); no hidden target acquisition through mission metadata |
| Supporting-radar and visible-launch source association, report expiry, CAP/escort limits and objective layout | Fitted/opinionated agent defaults | [Numbers and scope](spec/ai-awareness.md#assignment-delivery-and-observed-attack-reports), [target layout](spec/target-window.md) |
...
| AI leader and singleton return to base: the private landing route a wingman flies, then the airfield landing | Fitted, agent choice 2026-09-17, landing added 2026-09-23 | B48 closes this for a wingman with an AI leader only; `ai::fitted`, [AI airfield sequences](spec/ai-airfield.md#landing) |
| AI takeoff and landing sequences, gates, marshal, parking and bug out | Spec-derived from the retail handler trace | `ai::airfield`, `ai::mission`; [rules and numbers](spec/ai-airfield.md) |
| AI airfield substitutes for the hybrid model: creeping turn for the stopped pivot, late-rotation nose, final speed 1.1 times minimum under the 293 ft/s cap, speed-aware flare, terrain clearance, catastrophe-only landing ejection guard, nose-down rollout, gate abeam rule, speedbrake, go-around, runway-only fallback layout and landing end, cancellable ordered landing, no formating on a grounded human leader | Fitted, agent choice 2026-09-23 | Retail values alongside in [AI airfield sequences](spec/ai-airfield.md) |
| Quick Mission taxiway queue and runway-start takeoff clearance | Opinionated, requested by John 2026-09-23; spacing and cue scheduling fitted | [Placement](spec/quick-mission-menu.md#player-ground-start), [airfield radio](spec/airfield-radio.md) |
| AI wingman airport speech, display devices and runway depth correction | Fitted host integration of reviewed recordings and authoritative aircraft state | [Audio evidence and rendering regression](baselines/airfield-radio.md) |
| AI wingmen land at the player's selected airport | Opinionated, requested by John 2026-09-23 | [Orders](spec/ai-airfield.md#orders-and-warnings) |
...
| Quick Mission wing placement and formation steering projection | Fitted, agent choice 2026-09-17 | 512 ft slot spacing, 4096 ft between wing leader offsets, level stacking and a three-second leader-velocity projection. Exact rule and missing research in [mission wings](spec/quick-mission-menu.md#mission-wings) |
| Physical departure and controlled rejoin | Opinionated, requested by John 2026-09-18; thresholds fitted by agent | Separate trailing/breakout/intercept/stabilization/capture phases, coordinated approach priority and input-only motion. Public military procedures inform design, not retail provenance; [procedure and constants](spec/ai.md#physical-departure-and-rejoin) |
...
| Smooth close-formation wandering and routine slot transitions | Opinionated, requested by John 2026-09-18; parameters fitted by agent | [Variation limits, staged routes, shared intentions and emergency fallback](spec/ai.md#normal-formation-variation-and-transitions) |
