...
REGIONS = (
    ...
    ('player_damage_init', 0x40f77e, 0x40f7a4, 'damage'),
    ('subsystem_select', 0x40fd0a, 0x40fe40, 'damage'),
    ('subsystem_eligible', 0x410810, 0x4108aa, 'damage'),
    ('ecm_lookup', 0x452ea0, 0x452f74, 'sensors'),
    ('ecm_hit_probability', 0x4c348a, 0x4c34e0, 'sensors'),
    ('ecm_damage', 0x4104c1, 0x410576, 'damage'),
