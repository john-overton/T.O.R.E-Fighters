...
class ExportTests(unittest.TestCase):
    ...
    def test_separate_identity_preserves_donor_names_flags_and_sections(self):
        ...
        self.assertIn(b'dword $d3\r\n', result)
        self.assertNotIn(b'dword $93', result)
        ...
        self.assertIn(b'string "F22N.PT"', fixture)

    def test_hook_capability_is_verified_not_edited(self):
        source = b"dword $91\n;--- START OF PLANE_TYPE ---\n\n dword $d3\nword 17\n"
        self.assertEqual(verify_hook_capable_pt(source), source)
        for flags in (b'$91', b'$d1'):
            with self.assertRaises(ValueError):
                verify_hook_capable_pt(source.replace(b' dword $d3', b' dword ' + flags))

    def test_hookless_donor_is_rejected_by_the_identity_pass(self):
        fixture = (b"[brent's_relocatable_format]\r\nword 636\r\n"
                   b";--- START OF PLANE_TYPE ---\r\n\r\n    dword $d1\r\n"
                   b':ot_names\r\n string "F-22"\r\n string "Donor"\r\n string "F22N.PT"\r\n'
                   b':shape\r\n string "f22n.SH"\r\n:shadowShape\r\n string "f22n_s.SH"\r\nend\r\n')
        with self.assertRaises(ValueError):
            independent_pt(fixture)
